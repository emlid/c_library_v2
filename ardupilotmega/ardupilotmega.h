...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_VIDEO_START_STREAMING=2502, /* Starts video streaming |Camera ID (0 for all cameras), 1 for first, 2 for second, etc.| Frames per second| Resolution horizontal in pixels| Resolution vertical in pixels| Bit rate in bits/second (0 for auto)| Video image rotation clockwise (0-359 degrees)|  */
   MAV_CMD_VIDEO_STOP_STREAMING=2503, /* Stop the current video streaming |Camera ID| Reserved|  */
   MAV_CMD_REQUEST_VIDEO_STREAM_TARGET=2504, /* Request video stream target (VIDEO_STREAM_TARGET) |1: Request video stream target| Camera ID| Reserved (all remaining params)|  */
