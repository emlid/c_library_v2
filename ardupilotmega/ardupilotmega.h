...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_VIDEO_START_CAPTURE=2500, /* WIP: Starts video capture (recording) |Camera ID (0 for all cameras, 1 for first, 2 for second, etc.)| Frequency CAMERA_CAPTURE_STATUS messages should be sent while recording (0 for no messages, otherwise frequency in Hz)| Reserved|  */
   ...
   MAV_CMD_REQUEST_WIFI_NETWORKS=6000, /* Request saved/scanned Wi-Fi networks (see WIFI_NETWORK_INFORMATION). |0: No Action 1: Request messages with saved wifi network info 2: Request messages with scanned wifi network info| Reserved (all remaining params)|  */
   MAV_CMD_WIFI_START_AP=6001, /* Start in AP (Access Point) mode. |0: No Action 1: Start in AP mode| Reserved (all remaining params)|  */
   MAV_CMD_REQUEST_WIFI_STATUS=6002, /* Start in AP (Access Point) mode. |0: No Action 1: Request wifi status| Reserved (all remaining params)|  */
