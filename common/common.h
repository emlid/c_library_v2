...
/** @brief Type of Wi-Fi security */
#ifndef HAVE_ENUM_WIFI_SECURITY_TYPE
#define HAVE_ENUM_WIFI_SECURITY_TYPE
typedef enum WIFI_SECURITY_TYPE
{
   WIFI_SECURITY_TYPE_OPEN=0, /* No security | */
   WIFI_SECURITY_TYPE_WEP=1, /* WEP (Wired Equivalent Privacy) security | */
   WIFI_SECURITY_TYPE_WPA=2, /* WPA (Wi-Fi Protected Access) security | */
   WIFI_SECURITY_TYPE_WPA2=3, /* WPA2 (Wi-Fi Protected Access II) security | */
   WIFI_SECURITY_TYPE_ENUM_END=4, /*  | */
} WIFI_SECURITY_TYPE;
#endif
...
#include "./mavlink_msg_wifi_network_information.h"
#include "./mavlink_msg_wifi_status.h"
#include "./mavlink_msg_wifi_network_connect.h"
#include "./mavlink_msg_wifi_network_add.h"
#include "./mavlink_msg_wifi_network_delete.h"
