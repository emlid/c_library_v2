...
/** @brief Commands to be executed in order to get stream information on "VIDEO_STREAM_GET" message "command" field. */
#ifndef HAVE_ENUM_VIDEO_STREAM_GET_CMD
#define HAVE_ENUM_VIDEO_STREAM_GET_CMD
typedef enum VIDEO_STREAM_GET_CMD
{
   VIDEO_STREAM_GET_CMD_SERVER=1, /* Command to get server attributes | */
   VIDEO_STREAM_GET_CMD_STREAMS=2, /* Command to get available streams | */
   VIDEO_STREAM_GET_CMD_STREAM_ATTRIBUTES=3, /* Command to get attributes of a specific stream | */
   VIDEO_STREAM_GET_CMD_ENUM_END=4, /*  | */
} VIDEO_STREAM_GET_CMD;
#endif
...
#include "./mavlink_msg_video_stream_get.h"
#include "./mavlink_msg_video_stream_server.h"
#include "./mavlink_msg_set_video_stream_server.h"
#include "./mavlink_msg_video_stream_uri.h"
#include "./mavlink_msg_video_stream_attributes.h"
#include "./mavlink_msg_set_video_stream_attributes.h"
