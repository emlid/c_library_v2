...
#define MAVLINK_MSG_ID_VIDEO_STREAM_TARGET_LEN 50
#define MAVLINK_MSG_ID_VIDEO_STREAM_TARGET_MIN_LEN 50
#define MAVLINK_MSG_ID_269_LEN 50
#define MAVLINK_MSG_ID_269_MIN_LEN 50

#define MAVLINK_MSG_ID_VIDEO_STREAM_TARGET_CRC 115
#define MAVLINK_MSG_ID_269_CRC 115
...
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_TARGET { \
    ...
    {  { "port", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_video_stream_target_t, port) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_video_stream_target_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_video_stream_target_t, target_component) }, \
         { "camera_id", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_video_stream_target_t, camera_id) }, \
         { "ip", NULL, MAVLINK_TYPE_CHAR, 45, 5, offsetof(mavlink_video_stream_target_t, ip) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_VIDEO_STREAM_TARGET { \
...
{
    return mavlink_msg_video_stream_target_pack(system_id, component_id, msg, video_stream_target->target_system, video_stream_target->target_component, video_stream_target->camera_id, video_stream_target->ip, video_stream_target->port);
}
...
{
    return mavlink_msg_video_stream_target_pack_chan(system_id, component_id, chan, msg, video_stream_target->target_system, video_stream_target->target_component, video_stream_target->camera_id, video_stream_target->ip, video_stream_target->port);
}
...
static inline void mavlink_msg_video_stream_target_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t camera_id, const char *ip, uint16_t port)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VIDEO_STREAM_TARGET_LEN];
    _mav_put_uint16_t(buf, 0, port);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_video_stream_target_send(chan, video_stream_target->target_system, video_stream_target->target_component, video_stream_target->camera_id, video_stream_target->ip, video_stream_target->port);
#else
 ...
 */
static inline void mavlink_msg_video_stream_target_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t camera_id, const char *ip, uint16_t port)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field target_system from video_stream_target message
 *
 * @return system ID of the target
 */
static inline uint8_t mavlink_msg_video_stream_target_get_target_system(const mavlink_message_t* msg)
{
    return _MAV_RETURN_uint8_t(msg,  2);
}

/**
 * @brief Get field target_component from video_stream_target message
 *
 * @return component ID of the target
 */
static inline uint8_t mavlink_msg_video_stream_target_get_target_component(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_video_stream_target_decode(const mavlink_message_t* msg, mavlink_video_stream_target_t* video_stream_target)
{
    ...
    video_stream_target->target_system = mavlink_msg_video_stream_target_get_target_system(msg);
    video_stream_target->target_component = mavlink_msg_video_stream_target_get_target_component(msg);
