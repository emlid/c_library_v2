...
typedef struct __mavlink_wifi_network_information_t {
 ...
 uint8_t state; /*< Current status of connection (0: not connected 1: connected)*/
...
#define MAVLINK_MSG_ID_WIFI_NETWORK_INFORMATION_CRC 165
#define MAVLINK_MSG_ID_400_CRC 165
...
#define MAVLINK_MESSAGE_INFO_WIFI_NETWORK_INFORMATION { \
    ...
    {  { "ssid", NULL, MAVLINK_TYPE_CHAR, 32, 0, offsetof(mavlink_wifi_network_information_t, ssid) }, \
         ...
         { "state", NULL, MAVLINK_TYPE_UINT8_T, 0, 33, offsetof(mavlink_wifi_network_information_t, state) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_WIFI_NETWORK_INFORMATION { \
 ...
 * @param state Current status of connection (0: not connected 1: connected)
...
{
    return mavlink_msg_wifi_network_information_pack(system_id, component_id, msg, wifi_network_information->ssid, wifi_network_information->security_type, wifi_network_information->state);
}
...
{
    return mavlink_msg_wifi_network_information_pack_chan(system_id, component_id, chan, msg, wifi_network_information->ssid, wifi_network_information->security_type, wifi_network_information->state);
}
...
static inline void mavlink_msg_wifi_network_information_send(mavlink_channel_t chan, const char *ssid, uint8_t security_type, uint8_t state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_WIFI_NETWORK_INFORMATION_LEN];
    _mav_put_uint8_t(buf, 32, security_type);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_wifi_network_information_send(chan, wifi_network_information->ssid, wifi_network_information->security_type, wifi_network_information->state);
#else
 ...
 */
static inline void mavlink_msg_wifi_network_information_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const char *ssid, uint8_t security_type, uint8_t state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field state from wifi_network_information message
 *
 * @return Current status of connection (0: not connected 1: connected)
 */
static inline uint8_t mavlink_msg_wifi_network_information_get_state(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_wifi_network_information_decode(const mavlink_message_t* msg, mavlink_wifi_network_information_t* wifi_network_information)
{
    ...
    wifi_network_information->state = mavlink_msg_wifi_network_information_get_state(msg);
#else
