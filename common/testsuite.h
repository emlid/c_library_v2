...
static void mavlink_test_wifi_network_information(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_wifi_network_information_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_wifi_network_information_pack(system_id, component_id, &msg , packet1.ssid , packet1.security_type , packet1.state );
    mavlink_msg_wifi_network_information_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_wifi_network_information_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ssid , packet1.security_type , packet1.state );
    mavlink_msg_wifi_network_information_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_wifi_network_information_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_wifi_network_information_send(MAVLINK_COMM_1 , packet1.ssid , packet1.security_type , packet1.state );
    mavlink_msg_wifi_network_information_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
